...
import Group from '@/lib/svg-data/Group1321323012';
import PipelineGroup from '@/lib/svg-data/Group1321323012-6012-512';
    ...
    >
      <div className="relative w-[110px] h-[110px] lg:w-[130px] lg:h-[130px]">
        ...
        >
          ...
          <motion.div
            className="relative z-10 w-[24px] h-[28px] lg:w-[30px] lg:h-[35px]"
            style={{
...
function SecurityPipelineWithProduction({ delay = 0 }: { delay?: number }) {
  return (
    <motion.div
      ...
      transition={{ duration: 0.7, delay, ease }}
    >
      <div className="relative w-[266px] h-[150px] overflow-visible">
        <PipelineGroup />
      </div>
    </motion.div>
  );
