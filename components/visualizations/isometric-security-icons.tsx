  ...
  return (
    <div className="w-[160px] aspect-square relative flex items-center justify-center">
      <svg viewBox="0 0 200 200" fill="none" className="w-full h-full">
        {/* Isometric base platform - dashed */}
        <motion.path
    ...
    <div className="w-[160px] aspect-square relative flex items-center justify-center">
      <svg viewBox="0 0 200 200" fill="none" className="w-full h-full">
        ...
        <motion.g {...float}>
          ...
          {/* ── </> code symbol on top face, centered at centroid (100,72) ── */}
          {/* < bracket */}
          <motion.path
  ...
  return (
    <div className="w-[160px] aspect-square relative flex items-center justify-center">
      <svg viewBox="0 0 200 200" fill="none" className="w-full h-full">
        ...
        {/* Floating particles rising from layers */}
        <motion.circle
